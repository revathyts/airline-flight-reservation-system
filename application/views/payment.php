...
<script src="https://www.paypal.com/sdk/js?client-id=AXFJV_3IlYBDRVIs_CI_KGwHNWEhDcOeXYxIKYtSrtMAKqZwUCls6MI_-E7TSMpQOXVKOQyqqrqXTxxh"></script>
<script>paypal.Buttons({
    onApprove: function (data, actions) {
        return actions.order.capture().then(function (details) {
            console.log(details)
            window.location.replace("http://localhost/afrs/main/pay")
        })
    },
